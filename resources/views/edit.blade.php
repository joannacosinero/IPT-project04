...
@section('content')
<div class="container">
    <div class="mt-2"><a href="{{ url('/dashboard') }}" class="btn  btn-block text-white" style="background-color: #FA897B">Back</a></div>
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{url('/dashboard/edit/' . $item->id)}}" method="post">
                    ...
                    <button class="btn btn-block w-100 text-white" style="background-color: #FA897B" type="submit">Done</button>
                </form>
            </div>
        </div>
    </div>
